...
.factory('AuthenticationService',
    function (Base64, $http, $cookieStore, $rootScope, $timeout, $translate) {
        var service = {};
        ...
        service.Login = function (email, password, callback) {
            ...
            $http({
            	...
            	data    : 'email='+email+'&password='+password, //forms user object
            	headers : {'Content-Type': 'application/x-www-form-urlencoded'}
            
            }).error(function(data, status){
            	var message = $translate.instant('error.invalidMailOrPassword');
                var response = {
                		success: false,
                		message: message
                	};
